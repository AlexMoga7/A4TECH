...
enum playervEnum
{
	...
	pFightStyle, pPhoneBook, pFood, pHat, pWKills, pWDeaths, pGas, pFarmTimes, pFarmSkill, pDeelayDice, pDuty, pDeelayDuty, pQuest, pQuestValue, pQuestPrins, pQuestPoint, pSpecialSkin, pQuestFinalizat, pQuest2, pQuest2Value, pQuest2Prins, pLive[128], pUsingDrugs, pAreDrugs, pDrugsTime, pLoginAttempts, pHeadValue,
